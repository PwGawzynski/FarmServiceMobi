...
export const createUserSetup = (
  control: Control<CreateUserForm>,
  onPhoneNumberFocus: () => void,
  containsEmail?: boolean,
): FormControllerSetup<CreateUserForm> =>
  [
    ...[
      {
        control,
        ...
        textInputProp: {
          ...
          placeholder: t(
            TranslationNames.createClientForm.formPlaceholder.name,
          ),
        },
      },
      {
    ...
    containsEmail
      ...
      : undefined,
  ].filter(s => s !== undefined) as FormControllerSetup<CreateUserForm>;
