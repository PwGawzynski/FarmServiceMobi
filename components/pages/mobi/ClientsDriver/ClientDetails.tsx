...
>) {
  ...
  const { company } = route.params.client;
  return (
    <ScreenBase name={`${personalData.name} ${personalData.surname}`}>
      ...
      <Card bordered p="$2" mt="$4">
        ...
        />
        <KeyValuePair
          name={t(TranslationNames.addressForm.formPlaceholder.apartmentNumber)}
      ...
      <Card bordered p="$2" mt="$4">
        ...
        <SizableText
          ...
          mb="$2"
        >
          {t(TranslationNames.screens.authDriver.clientDetails.companyAddress)}
        </SizableText>
        <KeyValuePair
          name={t(TranslationNames.addressForm.formPlaceholder.city)}
      ...
      <CallButton phoneNumber={personalData.phone_number} />
    </ScreenBase>
  );
}
